...
void main() {
    ...
    // Transform position using camera MVP
    vec4 transformed_position = camera_mvp * vec4(pixel_position, 0.0, 1.0);

    gl_Position = transformed_position;

    vec2 uv_size = 1.0 / sprite_atlas_size * size;
    vec2 uv_location = 1.0 / sprite_atlas_size * location;
